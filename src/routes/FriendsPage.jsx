...
function FriendsPage() {
  ...
  const { friends: friendsState, fetchFriends } = useAppStore();
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          {isLoading &&
            friends.length === 0 && ( // Show loader only on initial load or if list is empty during load
            ...
            <>
              {friends.length === 0 ? (
                <p className="text-muted-foreground text-center py-10">
                  ...
                  {filterName ? " matching your search" : ""}.
                </p>
              ) : (
