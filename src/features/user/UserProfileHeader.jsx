...
import { getInitials } from "@/lib/getInitials"; // Import utility
...
function UserProfileHeader({ user }) {
  ...
  if (!user || !currentUser) {
    ...
    return (
      <div className="h-[268px] md:h-[300px] bg-muted rounded-lg mb-6 animate-pulse"></div>
    );
  }
  ...
  if (friendship) {
    ...
    if (friendship.status === "accepted") {
      ...
      actionContext =
        friendship.from === currentUser._id
          ? "outgoing_request"
          : "incoming_request";
    }
  }
