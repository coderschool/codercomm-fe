...
import { useGetFriendRequests } from "./friendHooks";
...
function FriendRequests() {
  ...
  const { data, isLoading } = useGetFriendRequests(filterName, page);
  ...
  return (
    <div className="container mx-auto">
      <h4 className="text-2xl font-bold mb-6">Friend Requests</h4>
      <Card className="p-6">
