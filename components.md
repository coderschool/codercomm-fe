...
This file documents the shadcn components we're using directly from their documentation. 
Since we're using JavaScript instead of TypeScript, we'll manually copy the JS versions.
